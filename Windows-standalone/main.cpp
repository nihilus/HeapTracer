...
struct {
	...
	{"ltrace", "ltrace -f -tt -i -efork,vfork,clone,malloc,realloc,free,calloc,mmap,munmap,mremap,mprotect,mmap2 /bin/ls", ltrace_input},
	{"truss", "truss -f -d -l -t \\!all -u a.out,*::malloc,realloc,free,calloc,fork,vfork,mmap,munmap,mprotect,brk /bin/ls", truss_input},
...
int main(int argc, char **argv) {
	...
	while (c!=-1) {
		switch (c=getopt(argc, argv, "qvt:p:r:aR:")) {
			case 'q': // quiet
				quiet = !quiet;
				break;
			case 't': // input type
